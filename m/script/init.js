...
function OnResize(){
	...
	if(cw>=1280){
		if(cw>=1280)vw=cw-806-50;
		if(cw>=1400)vw=cw-882-20;
		if(cw>=1600)vw=cw-1008-80;
			...
			// 一闪一闪的bug 15寸显示屏
			if (vw/16*9 == 315) {
				$('#OnLine_MV').css("height", 314);
			}

	}else {
		$('#UI_Central').css("margin-right","465px");
		$('#UI_Right').css("width",460);
		$('#OnLine_MV').css("height",460/16*9);
	}
	...
	$('#NoticeList').height($('#NoticeList').height()+$('#UI_Central').height()-$('#UI_Right').height()+10);
