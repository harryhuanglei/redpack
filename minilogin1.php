...
switch($act){
    ...
    case "reg":
        ...
        if($db->num_rows($query))exit("<script>alert('用户名已经被使用!换一个，如{$u}2015');location.href='?'</script>");
		if($row[onoff]==1){
...
<link href="images/minilogin1.css" rel="stylesheet" type="text/css"  />
...
<div class="login">
    ...
    <div class="header">
        <!-- <div class="switch" id="switch">
            ...
            <a class="switch_btn_focus" id="switch_qlogin" href="javascript:void(0);" tabindex="7">登陆</a>
        ...
        <div class="roe-sign">
            <strong>注册账号&nbsp;|&nbsp;</strong><span>已有账号，</span><a class="switch_btn_focus" id="switch_qlogin" href="javascript:;" tabindex="7">请登陆</a>
        </div>
        <div class="roe-login">
            <strong>登陆&nbsp;|&nbsp;</strong><span>还没有账号，</span><a class="switch_btn_focus" id="switch_login" href="javascript:;" tabindex="8">请注册</a>
        </div>
    </div>
...
<!--                <div id="userCue" class="cue">快速注册请注意格式</div>-->
                <div id="userCue" class="cue">用户名尽量与微信名一样 方便结算时能快速找到你</div>
                <li>
                    <label for="user"  class="input-tips2">用户名：</label>
                    <div class="inputOuter2">
                        <input type="text" id="u" name="u" maxlength="16" class="inputstyle2" placeholder="2-10个字符"/>
                    </div>
                </li>
                <!--
                <li>
                ...
                <li>
                    ...
                    <div class="inputOuter2">
                        <input placeholder="不少于6位" type="password" id="p"  name="p" maxlength="16" class="inputstyle2"/>
                    </div>
                </li>
                <li>
                    <label for="passwd2" class="input-tips2">确认密码：</label>
                    <div class="inputOuter2">
                        <input placeholder="请输入相同的密码" type="password" id="p2" name="p2" maxlength="16" class="inputstyle2" />
                    </div>
                ...
                <li style="display:none;">
                    ...
                    <div class="inputOuter3">
                     <?php if($row[onoff]==1){?>
                     <input onClick="get_yzm()" value="获取验证码" class="getcode text_input us_input getverify_sms " id="get_verification" type="button">
					 <input placeholder="请输入手机号" type="text" id="phone" name="phone" maxlength="11" class="inputstyle3"/>
					 <?php } else {?>
                     <input placeholder="请输入手机号" type="text" id="phone" name="phone" maxlength="11" class="inputstyle2"/>
                     <?php } ?>
                    </div>
  ...
  <?php } ?>
                ...
                <li>
                    <div class="inputArea">
                        <input type="submit" id="reg"  style="margin-top:10px;margin-left:85px;" class="button_blue" value="免 费 注 册"/> <a href="#" class="zcxy" target="_blank">注册协议</a>
                    </div>
...
$(document).ready(function() {
    ...
    $('#reg').click(function() {
        ...
        if ($('#u').val().length < 2 || $('#u').val().length > 10) {
