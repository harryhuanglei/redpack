...
<form action="" method="post" enctype="application/x-www-form-urlencoded" onSubmit="return docheck();">
<table width="100%" cellspacing="0" id="act_add_from"  style="border-left: 1px solid #C1DAD7;border-top: 1px solid #C1DAD7; margin-bottom:5px; display:none  ">
          <tr>
            ...
            %</td>
            <td align="right"><span class="tableleft">商品名称：</span></td>
            <td>
          ...
          <tr>
            ...
            <td><input type="submit" name="button" class="btn2" id="button" value="提交"></td>
          </tr>
    </table>
</form>
