		...
		var config = [{
			...
			menu: [{
				...
				items: [
					...
					<?php if(stripos($auth_rules,'users_admin')!==false) echo "{id:'1',text:'用户管理1',href:'users/users1.php'},";?>
					<?php if(stripos($auth_rules,'users_admin')!==false) echo "{id:'1',text:'结算列表',href:'users/account.php'},";?>
