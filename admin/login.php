...
<form method="post" enctype="application/x-www-form-urlencoded">
	<div style="height:350px; background:#27467e;position:relative;">
		<div style="position:relative; bottom:-300px; text-align:center"><span
				style=" color:#FFF; font-size:40px;font-family: Microsoft YaHei;text-shadow:5px 2px 6px #000;"><?= $cfg['config']['title'] ?>
				管理登录</span></div>
	</div>
